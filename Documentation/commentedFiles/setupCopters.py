...
## @file setupCopters.py
#  @brief An algorithm to setup copters in paparazzi environment
...
## @brief file path to scenarios
SCENARIO_DIR = path.dirname(path.abspath(__file__))
## @brief file path to configurations
CONF_DIR = path.normpath(path.join(SCENARIO_DIR, '../../../../conf'))
## @brief file path to copters
COPTER_DIR = path.normpath(path.join(CONF_DIR, 'airframes/ovgu'))
## @brief file path to flight plans
FLIGHT_PLAN_DIR = path.normpath(path.join(CONF_DIR, 'flight_plans/ovgu_swarm'))

## @brief setup attraction repulsion configuration
#  @param amounts amount of attraction repulsion points in scenario
...
## @brief setup context steering configuration
#  @param amounts amount of attraction repulsion points in scenario
...
#  @param file_name file name of scenario files
...
## @brief setup flight plans
#  @param file_name file name of scenario files
#  @return amounts amount of attraction and repulsion points in the scenario
...
if __name__=='__main__' and (len(sys.argv)>1):
  ## @brief amount of attraction and repulsion points
