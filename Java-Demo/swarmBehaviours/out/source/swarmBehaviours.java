...
class Drone {
  ...
  //update direction specific segments of all context maps
   public void create_context_segment(int dir, ArrayList<PVector> goals, ArrayList<PVector> noFlyZones, ArrayList<PVector> members)
  {
   ...
   public void context_steering(ArrayList<PVector> rayDirs, float sectorCosSim)
  {
    ...
    for(int idx=0; idx<this.DIRECTIONS; ++idx)
    {
      ...
      { 
        ...
        if(cosSim < sectorCosSim) force.mult(map(cosSim,-1.0f,sectorCosSim,0.001f,0.75f));
      }
